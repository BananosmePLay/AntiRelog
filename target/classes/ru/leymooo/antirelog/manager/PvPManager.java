...
public class PvPManager {
    ...
    public void reloadWhitelistedCommands() {
    ...
    private void tryStartPvP(Player attacker, Player defender) {
        if (plugin.getCooldownManager().hasProtection(attacker) ||
                plugin.getCooldownManager().hasProtection(defender)) {
            return;
        }
